	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/5drs.jpg" class="d-block w-100" alt="..."
					height="400px">
			</div>
			<div class="carousel-item">
				<img src="img/group1doc.jpg" class="d-block w-100" alt="..."
					height="400px">
			</div>
			<div class="carousel-item">
				<img src="img/5drs.jpg" class="d-block w-100" alt="..."
		...
		<div class="col-md-8 p-5">
			<div class="row">
					...
					<div class="card paint-card">
						<div class="card-body">
							...
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
								Totam magni, sunt nulla asperiores doloribus eum.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="card paint-card">
						<div class="card-body">
							<p class="fs-5">Clean Environmrnt</p>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
								Totam magni, sunt nulla asperiores doloribus eum.</p>
						</div>
					</div>
			...
			<div class="col-md-4">
				<img src="img/lady.jpg" alt="" height="360px">
			</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body" text-center>
						<img src="img/mDoc1.jpg" alt="" width="250px" height="300px">
